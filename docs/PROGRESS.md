...
| Source-present authored bytes | 216,830 |
| Source-present but non-exact functions | 159 |
| Source-present but non-exact bytes | 115,348 |
| Authored functions without maintained source | 79 |
| Authored bytes without maintained source | 58,839 |
| Canonical exact functions | 741 |
| Canonical exact authored bytes | 101,482 |
