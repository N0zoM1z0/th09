...
| Source-present authored bytes | 198,982 |
| Source-present but non-exact functions | 145 |
| Source-present but non-exact bytes | 110,683 |
| Authored functions without maintained source | 156 |
| Authored bytes without maintained source | 76,770 |
| Canonical exact functions | 679 |
| Canonical exact authored bytes | 88,299 |
