...
| Source-present authored bytes | 214,425 |
| Source-present but non-exact functions | 159 |
| Source-present but non-exact bytes | 115,348 |
| Authored functions without maintained source | 86 |
| Authored bytes without maintained source | 61,244 |
| Canonical exact functions | 734 |
| Canonical exact authored bytes | 99,077 |
