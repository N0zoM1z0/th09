...
| Source-present authored bytes | 198,277 |
| Source-present but non-exact functions | 145 |
| Source-present but non-exact bytes | 110,683 |
| Authored functions without maintained source | 163 |
| Authored bytes without maintained source | 77,475 |
| Canonical exact functions | 672 |
| Canonical exact authored bytes | 87,594 |
