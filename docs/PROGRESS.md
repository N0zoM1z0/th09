...
| Source-present authored bytes | 196,795 |
| Source-present but non-exact functions | 145 |
| Source-present but non-exact bytes | 110,683 |
| Authored functions without maintained source | 191 |
| Authored bytes without maintained source | 79,135 |
| Canonical exact functions | 654 |
| Canonical exact authored bytes | 86,112 |
