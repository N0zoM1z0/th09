...
| Source-present but non-exact functions | 199 |
| Source-present but non-exact bytes | 150,888 |
| Authored functions without maintained source | 0 |
| Authored bytes without maintained source | 0 |
| Canonical exact functions | 780 |
| Canonical exact authored bytes | 124,781 |
