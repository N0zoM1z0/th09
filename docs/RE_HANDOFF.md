...
| Source-present authored mappings | 841 |
| Canonical exact functions | 695 |
...
`config/implemented.csv` contains 841 source-present authored mappings. Of
these, 695 are canonical exact and 146 retain honest non-exact compiler results.
`config/matches.csv` contains 695 complete target-bound VC7.1 matches totaling
89,836 exact authored bytes. Source presence, origin, exactness, product
...
**138 authored functions / 74,418 bytes without maintained source**, plus 146
