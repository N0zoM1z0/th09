...
`config/implemented.csv` contains 910 source-present authored mappings. Of
these, 751 are canonical exact and 159 retain honest non-exact compiler results.
`config/matches.csv` contains 751 complete target-bound VC7.1 matches totaling
105,022 exact authored bytes. Source presence, origin, exactness, product
...
**69 authored functions / 55,299 bytes without maintained source**, plus 159
