...
| Source-present authored mappings | 878 |
...
`config/implemented.csv` contains 878 source-present authored mappings. Of
these, 727 are canonical exact and 151 retain honest non-exact compiler results.
...
**101 authored functions / 65,578 bytes without maintained source**, plus 151
