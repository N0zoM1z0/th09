...
`config/implemented.csv` contains 873 source-present authored mappings. Of
these, 724 are canonical exact and 149 retain honest non-exact compiler results.
...
**106 authored functions / 67,337 bytes without maintained source**, plus 149
