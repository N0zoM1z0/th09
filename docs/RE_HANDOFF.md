...
| Source-present authored mappings | 847 |
| Canonical exact functions | 700 |
...
`config/implemented.csv` contains 847 source-present authored mappings. Of
these, 700 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 700 complete target-bound VC7.1 matches totaling
90,550 exact authored bytes. Source presence, origin, exactness, product
...
**132 authored functions / 73,505 bytes without maintained source**, plus 147
