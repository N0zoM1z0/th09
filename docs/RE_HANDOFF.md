...
| Canonical exact functions | 837 |
| Source-present non-exact functions | 142 |
| Source-present non-exact bytes | 135,089 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 140,580 |
...
functions: 837 canonical exact and 142 honest non-exact.
