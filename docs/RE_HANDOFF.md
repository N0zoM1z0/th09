...
`config/implemented.csv` contains 849 source-present authored mappings. Of
these, 702 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 702 complete target-bound VC7.1 matches totaling
90,855 exact authored bytes. Source presence, origin, exactness, product
...
**130 authored functions / 73,200 bytes without maintained source**, plus 147
