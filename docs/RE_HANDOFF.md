...
| Source-present authored mappings | 893 |
| Canonical exact functions | 734 |
...
`config/implemented.csv` contains 893 source-present authored mappings. Of
these, 734 are canonical exact and 159 retain honest non-exact compiler results.
`config/matches.csv` contains 734 complete target-bound VC7.1 matches totaling
99,077 exact authored bytes. Source presence, origin, exactness, product
...
**86 authored functions / 61,244 bytes without maintained source**, plus 159
