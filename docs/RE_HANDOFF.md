...
| Canonical exact functions | 848 |
| Source-present non-exact functions | 131 |
| Source-present non-exact bytes | 133,021 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 142,648 |
...
functions: 848 canonical exact and 131 honest non-exact.
