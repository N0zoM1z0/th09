...
`config/implemented.csv` contains 901 source-present authored mappings. Of
these, 742 are canonical exact and 159 retain honest non-exact compiler results.
`config/matches.csv` contains 742 complete target-bound VC7.1 matches totaling
101,809 exact authored bytes. Source presence, origin, exactness, product
...
**78 authored functions / 58,512 bytes without maintained source**, plus 159
