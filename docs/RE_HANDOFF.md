...
`config/implemented.csv` contains 899 source-present authored mappings. Of
these, 740 are canonical exact and 159 retain honest non-exact compiler results.
`config/matches.csv` contains 740 complete target-bound VC7.1 matches totaling
101,124 exact authored bytes. Source presence, origin, exactness, product
...
**80 authored functions / 59,197 bytes without maintained source**, plus 159
