...
| Source-present authored mappings | 840 |
| Canonical exact functions | 694 |
...
`config/implemented.csv` contains 840 source-present authored mappings. Of
these, 694 are canonical exact and 146 retain honest non-exact compiler results.
`config/matches.csv` contains 694 complete target-bound VC7.1 matches totaling
89,739 exact authored bytes. Source presence, origin, exactness, product
...
**139 authored functions / 74,515 bytes without maintained source**, plus 146
