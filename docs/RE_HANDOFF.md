...
| Source-present authored mappings | 954 |
| Canonical exact functions | 767 |
...
`config/implemented.csv` contains 954 source-present authored mappings. Of
these, 767 are canonical exact and 187 retain honest non-exact compiler results.
`config/matches.csv` contains 767 complete target-bound VC7.1 matches totaling
114,253 exact authored bytes. Source presence, origin, exactness, product
...
**25 authored functions / 26,444 bytes without maintained source**, plus 187
