...
| Source-present authored mappings | 850 |
...
`config/implemented.csv` contains 850 source-present authored mappings. Of
these, 703 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 703 complete target-bound VC7.1 matches totaling
91,020 exact authored bytes. Source presence, origin, exactness, product
...
**129 authored functions / 73,035 bytes without maintained source**, plus 147
