...
`config/implemented.csv` contains 869 source-present authored mappings. Of
these, 720 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 720 complete target-bound VC7.1 matches totaling
94,587 exact authored bytes. Source presence, origin, exactness, product
...
**110 authored functions / 68,995 bytes without maintained source**, plus 149
