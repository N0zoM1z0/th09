...
| Canonical exact functions | 847 |
| Source-present non-exact functions | 132 |
| Source-present non-exact bytes | 133,300 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 142,369 |
...
functions: 847 canonical exact and 132 honest non-exact.
