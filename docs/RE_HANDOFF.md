...
| Source-present authored mappings | 856 |
| Canonical exact functions | 709 |
...
`config/implemented.csv` contains 856 source-present authored mappings. Of
these, 709 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 709 complete target-bound VC7.1 matches totaling
92,194 exact authored bytes. Source presence, origin, exactness, product
...
**123 authored functions / 71,861 bytes without maintained source**, plus 147
