...
| Canonical exact functions | 853 |
| Source-present non-exact functions | 126 |
| Source-present non-exact bytes | 131,533 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 144,136 |
...
functions: 853 canonical exact and 126 honest non-exact.
