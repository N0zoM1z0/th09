...
`config/implemented.csv` contains 886 source-present authored mappings. Of
these, 730 are canonical exact and 156 retain honest non-exact compiler results.
`config/matches.csv` contains 730 complete target-bound VC7.1 matches totaling
98,327 exact authored bytes. Source presence, origin, exactness, product
...
**93 authored functions / 62,785 bytes without maintained source**, plus 156
