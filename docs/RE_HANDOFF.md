...
| Source-present authored mappings | 862 |
| Canonical exact functions | 713 |
...
`config/implemented.csv` contains 862 source-present authored mappings. Of
these, 713 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 713 complete target-bound VC7.1 matches totaling
93,045 exact authored bytes. Source presence, origin, exactness, product
...
**117 authored functions / 70,537 bytes without maintained source**, plus 149
