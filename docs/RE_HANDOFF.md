...
`config/implemented.csv` contains 953 source-present authored mappings. Of
these, 766 are canonical exact and 187 retain honest non-exact compiler results.
...
**26 authored functions / 27,367 bytes without maintained source**, plus 187
