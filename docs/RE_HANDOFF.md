...
| Source-present non-exact functions | 125 |
| Source-present non-exact bytes | 131,345 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 144,324 |
...
functions: 854 canonical exact and 125 honest non-exact.
