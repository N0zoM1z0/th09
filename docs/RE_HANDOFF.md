...
| Source-present authored mappings | 848 |
| Canonical exact functions | 701 |
...
`config/implemented.csv` contains 848 source-present authored mappings. Of
these, 701 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 701 complete target-bound VC7.1 matches totaling
90,701 exact authored bytes. Source presence, origin, exactness, product
...
**131 authored functions / 73,354 bytes without maintained source**, plus 147
