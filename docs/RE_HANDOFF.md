...
| Canonical exact functions | 857 |
| Source-present non-exact functions | 122 |
| Source-present non-exact bytes | 130,296 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 145,373 |
...
functions: 857 canonical exact and 122 honest non-exact.
