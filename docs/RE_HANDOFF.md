...
| Canonical exact functions | 836 |
| Source-present non-exact functions | 143 |
| Source-present non-exact bytes | 135,151 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 140,518 |
...
functions: 836 canonical exact and 143 honest non-exact.
