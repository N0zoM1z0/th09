...
`config/implemented.csv` contains 864 source-present authored mappings. Of
these, 715 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 715 complete target-bound VC7.1 matches totaling
93,406 exact authored bytes. Source presence, origin, exactness, product
...
**115 authored functions / 70,176 bytes without maintained source**, plus 149
