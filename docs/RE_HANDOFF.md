...
| Source-present authored mappings | 866 |
| Canonical exact functions | 717 |
...
`config/implemented.csv` contains 866 source-present authored mappings. Of
these, 717 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 717 complete target-bound VC7.1 matches totaling
93,804 exact authored bytes. Source presence, origin, exactness, product
...
**113 authored functions / 69,778 bytes without maintained source**, plus 149
