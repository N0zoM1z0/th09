...
| Source-present authored mappings | 843 |
| Canonical exact functions | 697 |
...
`config/implemented.csv` contains 843 source-present authored mappings. Of
these, 697 are canonical exact and 146 retain honest non-exact compiler results.
`config/matches.csv` contains 697 complete target-bound VC7.1 matches totaling
90,059 exact authored bytes. Source presence, origin, exactness, product
...
**136 authored functions / 74,195 bytes without maintained source**, plus 146
