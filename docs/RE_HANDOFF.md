...
`config/implemented.csv` contains 892 source-present authored mappings. Of
these, 733 are canonical exact and 159 retain honest non-exact compiler results.
...
**87 authored functions / 61,552 bytes without maintained source**, plus 159
