...
| Canonical exact functions | 846 |
| Source-present non-exact functions | 133 |
| Source-present non-exact bytes | 133,609 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 142,060 |
...
functions: 846 canonical exact and 133 honest non-exact.
