...
`config/implemented.csv` contains 863 source-present authored mappings. Of
these, 714 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 714 complete target-bound VC7.1 matches totaling
93,246 exact authored bytes. Source presence, origin, exactness, product
...
**116 authored functions / 70,336 bytes without maintained source**, plus 149
