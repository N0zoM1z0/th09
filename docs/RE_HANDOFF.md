...
| Canonical exact functions | 838 |
| Source-present non-exact functions | 141 |
| Source-present non-exact bytes | 134,748 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 140,921 |
...
functions: 838 canonical exact and 141 honest non-exact.
