...
| Source-present authored mappings | 851 |
| Canonical exact functions | 704 |
...
`config/implemented.csv` contains 851 source-present authored mappings. Of
these, 704 are canonical exact and 147 retain honest non-exact compiler results.
`config/matches.csv` contains 704 complete target-bound VC7.1 matches totaling
91,296 exact authored bytes. Source presence, origin, exactness, product
...
**128 authored functions / 72,759 bytes without maintained source**, plus 147
