...
| Source-present authored mappings | 872 |
| Canonical exact functions | 723 |
...
`config/implemented.csv` contains 872 source-present authored mappings. Of
these, 723 are canonical exact and 149 retain honest non-exact compiler results.
`config/matches.csv` contains 723 complete target-bound VC7.1 matches totaling
96,023 exact authored bytes. Source presence, origin, exactness, product
...
**107 authored functions / 67,559 bytes without maintained source**, plus 149
