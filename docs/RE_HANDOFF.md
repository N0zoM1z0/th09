...
| Source-present authored mappings | 844 |
...
`config/implemented.csv` contains 844 source-present authored mappings. Of
these, 698 are canonical exact and 146 retain honest non-exact compiler results.
...
**135 authored functions / 74,031 bytes without maintained source**, plus 146
