...
| Canonical exact functions | 858 |
| Source-present non-exact functions | 121 |
| Source-present non-exact bytes | 129,849 |
| Authored without maintained source | 0 |
| Canonical exact authored bytes | 145,820 |
...
functions: 858 canonical exact and 121 honest non-exact.
