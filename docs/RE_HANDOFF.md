...
| Source-present authored mappings | 879 |
...
`config/implemented.csv` contains 879 source-present authored mappings. Of
these, 727 are canonical exact and 152 retain honest non-exact compiler results.
...
**100 authored functions / 65,103 bytes without maintained source**, plus 152
