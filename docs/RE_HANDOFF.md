...
| Source-present authored mappings | 962 |
...
`config/implemented.csv` contains 962 source-present authored mappings. Of
these, 771 are canonical exact and 191 retain honest non-exact compiler results.
...
**17 authored functions / 20,574 bytes without maintained source**, plus 189
