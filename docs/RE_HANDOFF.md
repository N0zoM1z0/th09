...
| Source-present authored mappings | 907 |
| Canonical exact functions | 748 |
...
`config/implemented.csv` contains 907 source-present authored mappings. Of
these, 748 are canonical exact and 159 retain honest non-exact compiler results.
`config/matches.csv` contains 748 complete target-bound VC7.1 matches totaling
103,927 exact authored bytes. Source presence, origin, exactness, product
...
**72 authored functions / 56,394 bytes without maintained source**, plus 159
